package net.lizhaoweb.common.util.http.httpclient.builder;
...
import net.lizhaoweb.common.util.http.common.SSLs;
...
public class HCB extends HttpClientBuilder {
	...
	public HCB ssl() throws HttpProcessException {
		...
		Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder.<ConnectionSocketFactory> create().register("http", PlainConnectionSocketFactory.INSTANCE).register("https", ssls.getSSLCONNSF()).build();
		// 设置连接池大小
