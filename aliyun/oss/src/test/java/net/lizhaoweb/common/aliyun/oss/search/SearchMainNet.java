...
import net.lizhaoweb.common.aliyun.oss.search.service.SearchFromOSSForSavorServiceNet;
...
public class SearchMainNet {
    ...
    public void init() {
        ...
        this.service = new SearchFromOSSForSavorServiceNet(ossClient);
    }
