...
public class BoxConfigNet {
    ...
    public static final String BOX_REGEX_SIMPLE = "^.+/([^/]+)_(\\d{10})\\.blog\\.zip$";
    public static final String BOX_REGEX_DETAIL = "^.+/([^/]+)_\\d{10}\\.blog\\.zip$";

    public static final String DIRECTORY_DATE_START = "20180801";// 开始日期(不包含)
    public static final String DIRECTORY_DATE_END = "20180831";// 结束日期(不包含)
    public static final String FILE_DATE_START = "2018080100";// 开始日期(包含)
    public static final String FILE_DATE_END = "2018083123";// 结束日期(包含)
    public static final int KEYS_SIZE = 1000;// 每次查询多少条，最大1000
